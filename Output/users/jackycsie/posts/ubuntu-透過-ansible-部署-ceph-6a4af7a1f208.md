...
![](images/6a4af7a1f208/1*jOLqbm0Slm8z18wrZv6RgA.jpeg "")
...
![](images/6a4af7a1f208/1*VYSs_Wp2K1uZeqOlOdcDVw.png "")
### Tips:
...
```
![](images/6a4af7a1f208/1*yU55i28uG2ZC1shkt-Usww.jpeg "")
...
![](images/6a4af7a1f208/1*qAiqEOXp-NtYCXS6Q4l7Fg.jpeg "")
- 透過 ansible ping 指令，檢查是否有設置正確 hosts。

```
root@ceph-ansible:~# ansible all -m ping
```
![](images/6a4af7a1f208/1*nKQX2M4Hhqk2Jpjwt3kACQ.jpeg "")
...
```
![](images/6a4af7a1f208/1*NObasYKjPv8f1EHcIu4C7A.jpeg "")
...
```
50: mon\_group\_name: mons  
51: osd\_group\_name: osds  
65: configure\_firewall: False  
103: ntp\_daemon\_type: ntpd  
125: ceph\_origin: repository  
132: ceph\_repository: community  
146: ceph\_mirror: [http://download.ceph.com](http://download.ceph.com)  
147: ceph\_stable\_key: [https://download.ceph.com/keys/release.asc](https://download.ceph.com/keys/release.asc)  
148: ceph\_stable\_release: octopus  
149: ceph\_stable\_repo: "{{ ceph\_mirror }}/debian-{{ ceph\_stable\_release }}"
...
```
#### 完成 !
![](images/6a4af7a1f208/1*7_nPOonnlpmBCzo3NoXomQ.png "")



+-----------------------------------------------------------------------------------+

| **[View original post on Medium](https://medium.com/jacky-life/ubuntu-%E9%80%8F%E9%81%8E-ansible-%E9%83%A8%E7%BD%B2-ceph-6a4af7a1f208) - Converted by [ZhgChgLi](https://blog.zhgchg.li)/[ZMediumToMarkdown](https://github.com/ZhgChgLi/ZMediumToMarkdown)** |
